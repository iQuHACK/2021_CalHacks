...
public class RZGateBlockEntity extends GateBlockEntity {

  private int dummy_number = 7;

  public RZGateBlockEntity() {
    super(BloqMod.RZ_GATE_BLOCK_ENTITY);
  }
  ...
  public void setStack(int slot, ItemStack stack) {
    if (slot == 0) {
      if (!this.world.isClient) {
        ...
        watcher.appendQubitGate(stack, "rz", getParameter());
